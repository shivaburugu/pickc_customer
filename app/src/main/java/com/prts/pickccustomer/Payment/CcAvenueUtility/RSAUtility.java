package com.prts.pickccustomer.Payment.CcAvenueUtility;
...
//        PublicKey publicKeys = KeyFactory.getInstance("RSA").generatePublic(
//                new X509EncodedKeySpec(DatatypeConverter.parseBase64Binary(key)));
        try{
