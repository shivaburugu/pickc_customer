...
public class WebViewActivityforInvoice extends AppCompatActivity {
    ...
    private class CustomWebViewClient extends WebViewClient {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            progressDialog = new ProgressDialog(WebViewActivityforInvoice.this,R.style.AppDialogTheme1);
